...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Hiển thị tất cả ' + postTitle.length + 'bài viếts<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">Lọc hiển thị ' + numDisplayed + ' posts labeled \'';
